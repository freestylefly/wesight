...
| P2 | 部分完成 | 模板动态字段、案例 prompt 逆向拆解、自然语言填表、模板感知 directions、模板说明展示已落地 | Context Pack 只有素材清单、尺寸和色彩，缺少 role-specific instruction 与可执行摘要 | 推进 Context Pack role strategy |
